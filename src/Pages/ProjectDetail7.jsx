...
import ssproject1 from "../assets/Ss1-p-7.png";
import ssproject2 from "../assets/Ss2-p-7.png";
import ssproject3 from "../assets/Ss3-p-7.png";
...
export default function ProjectDetailPage7() {
      ...
      <div className="mt-10 flex flex-col lg:flex-row gap-10">
        ...
        >
          <motion.div variants={boxVariants}>
            <h1 className="text-4xl font-bold mb-1">Aether Walk</h1>
          ...
          <motion.div variants={boxVariants}>
            ...
            <p className="text-gray-300 leading-relaxed">
              Website statis untuk mempromosikan toko sepatu Aether Walk, menampilkan produk seperti Nike Air Jordan. Dibuat dengan HTML, CSS, dan JavaScript tanpa backend.{" "}
          ...
          <motion.div variants={boxVariants}>
            ...
            <div className="flex gap-2">
              ...
              <p className="text-gray-300">1 September 2024</p>
            </div>
          </motion.div>
          ...
          >
            <a href="https://shoespromotion.netlify.app/" target="_blank" rel="noopener noreferrer">
