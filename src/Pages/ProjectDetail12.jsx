...
import ssproject1 from "../assets/Ss1-p-12.png";
import ssproject2 from "../assets/Ss2-p-12.png";
...
const images = [project1,ssproject1, ssproject2,];

export default function ProjectDetailPage12() {
        ...
        >
          ...
          <motion.div variants={boxVariants}>
            ...
            <p className="text-gray-300 leading-relaxed">
              Website dashboard admin untuk mengelola data secara efisien. Dibuat menggunakan Laravel, CSS, dan Bootsrap dengan desain antarmuka modern dan responsif.
              <span className="text-[#00FFD1] font-medium">Laravel, dan Bootsrap</span>.
            </p>
          </motion.div>
          ...
          <motion.div variants={boxVariants}>
            ...
            <div className="flex gap-2">
              ...
              <p className="text-gray-300">4 Mei 2024</p>
            </div>
          </motion.div>
          ...
          >
            <a href="https://lar-crud.rplrus.com/" target="_blank" rel="noopener noreferrer">
