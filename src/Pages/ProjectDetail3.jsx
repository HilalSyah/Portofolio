...
import project1 from "../assets/Ld1.png";
import ssproject1 from "../assets/Ss1-p-3.png";
import { useNavigate } from "react-router-dom";
import { motion, AnimatePresence } from "framer-motion";
import { FaHtml5, FaCss3Alt, FaJs, FaBootstrap } from "react-icons/fa";

const images = [project1, ssproject1];

export default function ProjectDetailPage3() {
        ...
        >
          ...
          <motion.div variants={boxVariants}>
            ...
            <p className="text-gray-300 leading-relaxed">
              Website landing page untuk promosi yang di bangun dengan menggunakan tech HTML,CSS dan Bootstrap <span className="text-[#00FFD1] font-medium">HTML, CSS, dan JavaScript</span>.
            </p>
          </motion.div>
          ...
          <motion.div variants={boxVariants}>
            ...
            <div className="flex gap-2">
              ...
              <p className="text-gray-300">5 Januari 2024</p>
            </div>
          </motion.div>
          ...
          >
            <a href="https://hilalsyah.github.io/Landing-Page-BS/" target="_blank" rel="noopener noreferrer">
