...
import ssproject1 from "../assets/Ss1-p-11.png";
import ssproject2 from "../assets/Ss2-p-11.png";
import ssproject3 from "../assets/Ss3-p-11.png";
...
const images = [ssproject1, ssproject2, ssproject3];

export default function ProjectDetailPage11() {
      ...
      <div className="mt-10 flex flex-col lg:flex-row gap-10">
        ...
        >
          <motion.div variants={boxVariants}>
            <h1 className="text-4xl font-bold mb-1">Dashboard Admin Data Siswa</h1>
          ...
          <motion.div variants={boxVariants}>
            ...
            <p className="text-gray-300 leading-relaxed">
              Website dashboard admin untuk mengelola data siswa, kelas, dan jurusan secara efisien. Dibuat menggunakan Laravel, Flowbite, dan Tailwind CSS dengan desain antarmuka modern dan responsif.
              <span className="text-[#00FFD1] font-medium">Laravel, dan Tailwind</span>.
            </p>
          </motion.div>
          ...
          <motion.div variants={boxVariants}>
            ...
            <div className="flex gap-2">
              ...
              <p className="text-gray-300">10 Agustus 2024</p>
            </div>
          </motion.div>
          ...
          >
            <a href="https://daftar-siswa.rplrus.com/" target="_blank" rel="noopener noreferrer">
