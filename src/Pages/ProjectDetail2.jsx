...
import project1 from "../assets/Projek2.png";
import ssproject1 from "../assets/Ss1-p-2.png";
import ssproject2 from "../assets/Ss2-p-2.png";
import ssproject3 from "../assets/Ss3-p-2.png";
import { useNavigate } from "react-router-dom";
import { motion, AnimatePresence } from "framer-motion";
import { FaHtml5, FaCss3Alt, FaJs } from "react-icons/fa";

const images = [project1, ssproject2, ssproject3, ssproject1];
      ...
      <div className="mt-10 flex flex-col lg:flex-row gap-10">
        ...
        >
          <motion.div variants={boxVariants}>
            <h1 className="text-4xl font-bold mb-1">StudySpace</h1>
          ...
          <motion.div variants={boxVariants}>
            ...
            <p className="text-gray-300 leading-relaxed">
              Website informasi dan data kelas yang di bangun dengan tech HTML,CSS dan JS <span className="text-[#00FFD1] font-medium">HTML, CSS, dan JavaScript</span>.
            </p>
          </motion.div>
          ...
          <motion.div variants={boxVariants}>
            ...
            <div className="flex gap-2">
              ...
              <p className="text-gray-300">16 Desember 2023</p>
            </div>
          </motion.div>
