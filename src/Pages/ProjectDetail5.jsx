...
export default function ProjectDetailPage5() {
      ...
      <div className="mt-10 flex flex-col lg:flex-row gap-10">
        ...
        >
          <motion.div variants={boxVariants}>
            <h1 className="text-4xl font-bold mb-1">Disney Clone</h1>
          ...
          <motion.div variants={boxVariants}>
            ...
            <p className="text-gray-300 leading-relaxed">
              Landing page yang menampilkan daftar film populer menggunakan data dari TMDb API. Dibangun dengan React.js dan Tailwind CSS. <span className="text-[#00FFD1] font-medium">Next.Js, dan Tailwind</span>.
            </p>
          </motion.div>
          ...
          <motion.div variants={boxVariants}>
            ...
            <div className="flex gap-2">
              ...
              <p className="text-gray-300">20 Desember 2024</p>
            </div>
          </motion.div>
          ...
          >
            <a href="https://weblistfilmreacthilal.vercel.app/" target="_blank" rel="noopener noreferrer">
