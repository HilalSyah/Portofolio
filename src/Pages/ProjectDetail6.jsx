...
import ssproject1 from "../assets/Ss1-p-6.png";
import ssproject2 from "../assets/Ss2-p-6.png";
import ssproject3 from "../assets/Ss3-p-6.png";
import ssproject4 from "../assets/Ss4-p-6.png";
import { useNavigate } from "react-router-dom";
import { motion, AnimatePresence } from "framer-motion";
import { FaHtml5, FaCss3Alt, FaJs } from "react-icons/fa";

const images = [ssproject1, ssproject2, ssproject3, ssproject4];

export default function ProjectDetailPage6() {
      ...
      <div className="mt-10 flex flex-col lg:flex-row gap-10">
        ...
        >
          <motion.div variants={boxVariants}>
            <h1 className="text-4xl font-bold mb-1">Kopi Alam Senja</h1>
          ...
          <motion.div variants={boxVariants}>
            ...
            <p className="text-gray-300 leading-relaxed">
              Website statis yang menampilkan halaman pemesanan kopi bernuansa alam. Dibuat dengan HTML dan CSS tanpa backend. <span className="text-[#00FFD1] font-medium">HTML, CSS, dan JavaScript</span>.
            </p>
          </motion.div>
          ...
          <motion.div variants={boxVariants}>
            ...
            <div className="flex gap-2">
              ...
              <p className="text-gray-300">16 Mei 2023</p>
            </div>
          </motion.div>
          ...
          >
            <a href="https://hilalsyah.github.io/Web-Kelas/" target="_blank" rel="noopener noreferrer">
