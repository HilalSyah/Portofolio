...
import project1 from "../assets/Project10.png";
import ssproject1 from "../assets/Ss1-p-10.png";
import ssproject2 from "../assets/Ss2-p-10.png";
import ssproject3 from "../assets/Ss3-p-10.png";
...
const images = [project1, ssproject1, ssproject2, ssproject3];

export default function ProjectDetailPage10() {
      ...
      <div className="mt-10 flex flex-col lg:flex-row gap-10">
        ...
        >
          <motion.div variants={boxVariants}>
            <h1 className="text-4xl font-bold mb-1">Tiketing Dashboard Admin </h1>
            <p className="text-sm text-gray-400">(Fullstack Laravel)</p>
          </motion.div>

          <motion.div variants={boxVariants}>
            <p className="font-semibold text-xl mb-1">Description</p>
            <p className="text-gray-300 leading-relaxed">
              Dashboard admin untuk mengelola tiket dan booking secara manual. Dibuat dengan Laravel, Filament, dan Tailwind CSS dengan tampilan modern dan responsif. <span className="text-[#00FFD1] font-medium">Laravel, dan Tailwind</span>
              .
            </p>
            <div className="mt-1 text-sm">
              <p>Demo Akun :</p>
              <p>Email : Admin@gmail.com</p>
              <p>Password : Admin112233</p>
            </div>
          </motion.div>
          ...
          <motion.div variants={boxVariants}>
            ...
            <div className="flex gap-2">
              ...
              <p className="text-gray-300">18 April 2025</p>
            </div>
          </motion.div>
          ...
          >
            <a href="https://dasboardfil.rplrus.com/admin/" target="_blank" rel="noopener noreferrer">
