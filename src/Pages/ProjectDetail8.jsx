...
import project1 from "../assets/Project8.png";
import ssproject1 from "../assets/Ss1-p-8.png";
import ssproject2 from "../assets/Ss2-p-8.png";
import ssproject3 from "../assets/Ss3-p-8.png";
...
export default function ProjectDetailPage8() {
      ...
      <div className="mt-10 flex flex-col lg:flex-row gap-10">
        ...
        >
          <motion.div variants={boxVariants}>
            <h1 className="text-4xl font-bold mb-1">Website Undangan Pernikahan </h1>
          ...
          <motion.div variants={boxVariants}>
            ...
            <p className="text-gray-300 leading-relaxed">
              Website statis untuk undangan pernikahan digital yang menampilkan informasi acara, galeri foto, dan countdown hari pernikahan. Dibuat menggunakan HTML, CSS, dan JavaScript tanpa backend.{" "}
              <span className="text-[#00FFD1] font-medium">HTML, CSS, dan JavaScript</span>.
            </p>
          </motion.div>
          ...
          <motion.div variants={boxVariants}>
            ...
            <div className="flex gap-2">
              ...
              <p className="text-gray-300">10 November 2024</p>
            </div>
          </motion.div>
          ...
          >
            <a href="https://udangan-nikah-web.netlify.app/" target="_blank" rel="noopener noreferrer">
